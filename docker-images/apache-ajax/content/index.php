            ...
            <div class="row justify-content-center">
                <div class="col-lg-5">
                    <div class="section-title text-center pb-30">
                        ...
                        <h3 class="title"><span>Rencontrez</span> la Dream Team</h3>
                    </div> <!-- section title -->
                </div>
            </div> <!-- row -->
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="team-content">
                            <h5 class="holder-name"><a href="#">Loris Marzullo</a></h5>
                            <p class="text">Wanker of the team</p>
                        </div>
                    </div> <!-- single team -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="team-content">
                            <h5 class="holder-name"><a href="#">Géraud Silvestri</a></h5>
                            <p class="text">Food tester</p>
                        </div>
                    </div> <!-- single team -->
                </div>
                <div class="col-lg-4 col-md-7 col-sm-8">
                    <div class="single-team text-center mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                        ...
                        <div class="team-content">
                            <h5 class="holder-name"><a href="#">Loïc Rosset</a></h5>
                            <p class="text">Quota requirement</p>
                        </div>
                    </div> <!-- single team -->
                </div>
            </div> <!-- row -->
            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.2s">
                        ...
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Loïc</a></li>
                                <li>03 June, 1900</li>
                            </ul>
                            <p class="text">Monke</p>
                ...
                <div class="col-lg-4 col-md-7">
                    <div class="single-blog mt-30 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.5s">
                        ...
                        <div class="blog-content">
                            <ul class="meta">
                                <li>Posted By: <a href="#">Loris</a></li>
                                <li>03 June, 2021</li>
                            </ul>
                    ...
                    <div class="col-lg-3 col-md-5 col-sm-5">
                        <div class="footer-contact mt-50 wow fadeIn" data-wow-duration="1s" data-wow-delay="0.8s">
                            ...
                            <ul class="contact">
                                ...
                                <li>www.dreamland.com</li>
                                <li>123 Streetz New York City , United <br> States Of America 7500 (MURICA).</li>
                            </ul>
                        </div> <!-- footer contact -->
                    </div>
                </div> <!-- row -->
                    ...
                    <div class="col-lg-12">
                        <div class="copyright d-sm-flex justify-content-between">
                            <div class="copyright-content">
                                <p class="text">Designed and Developed by <a href="https://uideck.com" rel="nofollow">Un gentil monsieur</a></p>
